package com.ubirch.swagger.example.Utils

import java.util

import com.ubirch.swagger.example.GetVertexes
...
/*
    ...
    def main(args: Array[String]): Unit = {
      val vertex = GetVertexes.getVertexDepth(1, 5);
      arrayVertexWithDistanceToJson(vertex);
    }
*/
